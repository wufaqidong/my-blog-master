<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getSiteClassList"></right-toolbar>
    </el-row>
    ...
    <div style="margin-top: 5px">
      <el-table border :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button @click="handleNavigationList(scope.row.id)" type="success" size="mini">列表</el-button>
...
<script>
import { getSiteClassList, save, update, deleteBatch } from "@/api/siteClass"
...
export default {
  ...
  computed: {
    ...
    canList() {
      return hasAuth(this.pres, '/system/siteClass/list')
    },
    canAdd() {
      return hasAuth(this.pres, '/system/siteClass/insert')
    },
    canUpdate() {
      return hasAuth(this.pres, '/system/siteClass/update')
    },

    canDeleteBatch() {
      return hasAuth(this.pres, '/system/siteClass/deleteBatch')
    }
  },
  created() {

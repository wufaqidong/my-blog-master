  ...
  <div class="app-container">
    ...
    <el-form v-show="showSearch" :inline="true" ref="form" :model="params" label-width="68px">
      <el-form-item label="分类名称">
        <el-select size="small" v-model="params.siteClassId" placeholder="请选择分类名称" @change="handleFind">
          <el-option v-for="item in siteClassList" :key="item.id" :label="item.name" :value="item.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getNavigationList"></right-toolbar>
    </el-row>
...
import { getSiteClassList } from "@/api/siteClass"
...
export default {
  ...
  computed: {
    ...
    canList: function () {
      return hasAuth(this.pres, '/system/navigation/list')
    },
    canAdd: function () {
      return hasAuth(this.pres, '/system/navigation/insert')
    },
    canUpdate: function () {
      return hasAuth(this.pres, '/system/navigation/update')
    },
    canDeleteBatch: function () {
      return hasAuth(this.pres, '/system/navigation/deleteBatch')
    }
  },
  created() {
